...
/**
 * Provides a form for deleting a batch_import entity.
 *
 * @ingroup batch_import
 */
class ImportForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $url = $host . '/' . drupal_get_path('module', 'batch_import') . '/docs/animals.json';
    ...
    foreach($data as $item) {
      $batch['operations'][] = [['\Drupal\batch_import\Form\ImportForm', 'importAnimal'], [$item]];
    }
